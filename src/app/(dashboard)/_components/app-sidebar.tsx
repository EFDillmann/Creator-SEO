  ...
  return (
    <aside className="fixed left-0 top-0 z-20 flex h-screen w-64 flex-col border-r border-gray-200 bg-white">
      <div className="flex items-center gap-2 border-b border-gray-100 p-6 text-red-500">
        ...
        <Link href="/dashboard" className="text-xl font-bold tracking-tight text-black hover:text-black">
          CreatorSEO.ai
        </Link>
      </div>
      ...
      <div className="border-t border-gray-100 p-4">
        <a
          ...
          className="group flex w-full items-center gap-3 px-3 py-2 text-sm font-medium text-[#606060] transition-colors hover:text-red-500"
        >
          <Icon name="logout" className="transition-colors group-hover:text-red-500" />
